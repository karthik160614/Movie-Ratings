...
A simple and responsive movie rating website built using HTML and CSS. This project allows users to view movie details and provide ratings through a clean and user-friendly interface. It focuses on practicing core front-end skills like layout design, styling, and responsive web development without using any frameworks or JavaScript.
